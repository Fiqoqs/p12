...
import com.example.p12.databinding.ActivityMainBinding
...
//            Mengubah img menjadi bitmap
            ...
            val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.h)
            ...
            val builder = NotificationCompat.Builder(this, channelId)
                ...
                .setContentText("Counter Skeleton")
                .setAutoCancel(true)
                .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                .setStyle(NotificationCompat.BigPictureStyle().bigPicture(notifImage))
                .addAction(R.drawable.tu, "Suka", pendingIntentSuka)
                .addAction(R.drawable.td, "Tidak Suka", pendingIntentTidakSuka)
